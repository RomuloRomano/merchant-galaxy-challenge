...
/**
 * This class  represent the translate message in the application
 *
 */
public class GalaxyTranslateMessage {
    ...
    public String getMessage(GalaxyQuestionReturnCode error)
    {
        ...
        switch(error)
        {
            ...
            case INVALID : message = "Input format is wrong ! input discarded";
                break;
            case INVALID_GALAXY_CHARACTER:_CHARACTER : message = "Illegal character specified in roman number ! input discarded";
                break;
            case INVALID_GALAXY_STRING:_STRING : message =  "wrong Roman number, voilated roman number format";
                break;
